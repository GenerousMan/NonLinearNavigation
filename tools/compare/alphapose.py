...
from lib.AlphaPose.dataloader import ImageLoader, VideoLoader, CustomLoader, DetectionLoader, DetectionProcessor, DataWriter, Mscoco
from lib.AlphaPose.SPPE.src.main_fast_inference import *
from lib.AlphaPose.fn import getTime
...
def calc_pose_of_videos_v2(videos, taskId=None):
    ...
    for i in im_names_desc:
        ...
        if taskId: progress.set_(taskId, 'alphapose', i + 1, data_len)
